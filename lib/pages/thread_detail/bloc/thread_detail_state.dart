...
class ThreadDetailStateContent extends ChanState {
  ...
  ThreadDetailStateContent(this.model, this.selectedPostId, this.isFavorite, this.catalogMode, this.lazyLoading, this.event);
  ...
  @override
  List<Object> get props => [model, selectedPostId, isFavorite, catalogMode, lazyLoading, event];
}
